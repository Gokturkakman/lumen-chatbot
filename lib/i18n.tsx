...
const dictionaries = {
  tr: {
    ...
    "composer.disclaimer": "Lumen hata yapabilir. Önemli bilgileri doğrula.",
    ...
    "message.regenerate": "Yeniden oluştur",
    "message.helpful": "İyi yanıt",
    "message.unhelpful": "Kötü yanıt",
    "message.feedbackThanks": "Geri bildirimin için teşekkürler",
  ...
  en: {
    ...
    "composer.disclaimer": "Lumen can make mistakes. Check important facts.",
    ...
    "message.helpful": "Good response",
    "message.unhelpful": "Bad response",
    "message.feedbackThanks": "Thanks for the feedback",
